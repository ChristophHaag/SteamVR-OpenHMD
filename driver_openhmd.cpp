...
public:
	VRInputComponentHandle_t trigHandle;
	VRInputComponentHandle_t gripHandle;
	VRInputComponentHandle_t sysHandle;
	VRInputComponentHandle_t appHandle;
	VRInputComponentHandle_t tracpadHandle;
	bool tempval = false;
	double mov = 0;
    int index;
	...
	vr::VRDriverInput()->CreateScalarComponent(ulPropertyContainer, "/input/trackpad/x", &tracpadHandle, VRScalarType_Absolute, VRScalarUnits_NormalizedTwoSided);
	...
	vr::EVRInputError err = VRDriverInput()->CreateBooleanComponent(ulPropertyContainer, "/input/trigger/click", &trigHandle);
	vr::EVRInputError err1 = VRDriverInput()->CreateBooleanComponent(ulPropertyContainer, "/input/grip/click", &gripHandle);
	vr::VRDriverInput()->CreateBooleanComponent(ulPropertyContainer, "/input/system/click", &sysHandle);
	vr::VRDriverInput()->CreateBooleanComponent(ulPropertyContainer, "/input/application_menu/click", &appHandle);
